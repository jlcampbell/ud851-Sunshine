...
public class MainActivity extends AppCompatActivity implements
    ...
    private void openLocationInMap() {
        // c (9) Use preferred location rather than a default location to display in the map
        String addressString = "1600 Ampitheatre Parkway, CA";

        String preferredAddressString = SunshinePreferences.getPreferredWeatherLocation(this);

        addressString = preferredAddressString;
