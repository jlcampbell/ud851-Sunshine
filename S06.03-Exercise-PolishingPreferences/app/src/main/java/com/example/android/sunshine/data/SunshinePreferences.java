...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        // c (1) Return the user's preferred location
        /** This will be implemented in a future lesson **/
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String key = context.getResources().getString(R.string.pref_location_key);
        String defaultLocation = context.getResources().getString(R.string.pref_location_default);
        String prefLocation =  sharedPreferences.getString(key,defaultLocation);
        return prefLocation;
    }
    ...
    public static boolean isMetric(Context context) {
        // c (2) Return true if the user's preference for units is metric, false otherwise
        /** This will be implemented in a future lesson **/
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String key = context.getResources().getString(R.string.pref_units_key);
        String defaultMetric = context.getResources().getString(R.string.pref_units_metric);
        String preferredUnits = sharedPreferences.getString(key, defaultMetric);
        if (preferredUnits.equals(defaultMetric)){
            return true;
        }
        else
            return false;
