...
//  c (37) Remove the error TextView
    ...
    //  c (35) Remove the preference change flag
...
//  c (21) Refactor onCreateLoader to return a Loader<Cursor>, not Loader<String[]>
    /**
...
// c (22) If the loader requested is our forecast loader, return the appropriate CursorLoader

    }


//  c (26) Change onLoadFinished parameter to a Loader<Cursor> instead of a Loader<String[]>
    /**
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        //      c (27) Remove the previous body of onLoadFinished
        //      c (28) Call mForecastAdapter's swapCursor method and pass in the new Cursor
        mForecastAdapter.swapCursor(data);
        //      c (29) If mPosition equals RecyclerView.NO_POSITION, set it to 0
        ...
        //      c (30) Smooth scroll the RecyclerView to mPosition
        //      c (31) If the Cursor's size is not equal to 0, call showWeatherDataView
        if (data.getCount() != 0){
            showWeatherDataView();
        }
    }
...
//      c (32) Call mForecastAdapter's swapCursor method and pass in null
...
//  c (34) Create a method called showLoading that shows the loading indicator and hides the data
