...
//  c (2) Remove all the TextView declarations
    /**
...
**/
     ...
     */
//  c (3) Declare an ActivityDetailBinding field called mDetailBinding
    ActivityDetailBinding mDetailBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//      c (4) Remove the call to setContentView
        //setContentView(R.layout.activity_detail);

//      c (5) Remove all the findViewById calls
        /*
...
*/
//      c (6) Instantiate mDetailBinding using DataBindingUtil
...
//      c (7) Display the weather icon using mDetailBinding
       int imageRes = SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(data.getInt(INDEX_WEATHER_CONDITION_ID));
       mDetailBinding.primaryWeatherInfo.weatherIcon.setImageResource(imageRes);
        /****************
         * Weather Date *
         ****************/
        /*
...
//      c (8) Use mDetailBinding to display the date
...
//      c (9) Use mDetailBinding to display the description and set the content description
...
//      c (10) Use mDetailBinding to display the high temperature and set the content description
